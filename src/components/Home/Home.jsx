      ...
      <div>
        <section className={blur ? "myStyle showcase" : "showcase"}>
          ...
          <div className="text">
            ...
            <h4>
              ƦłÐE ŦØ ØBJE₡ŦłVE ₩łŦҤ λ₣₣ł₦łŦ¥.
              <br />
            </h4>
            <h2>
              Embargo is first step towards to help pioneers to reach their
              destination in cheapest price and short time.
            </h2>
            <br />
            <div>
        ...
        <CSSTransition in={isOpenRegister} timeout={300} classNames="dialog">
          <Modal
        ...
        <CSSTransition in={isOpenLogin} timeout={300} classNames="dialog">
          <Modal
            isOpen={isOpenLogin}
